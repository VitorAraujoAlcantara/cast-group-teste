...
{
    public class CusroInsertDtoValidatorTest
    {
        private readonly AbstractValidator<CursoInsertDto> validations;
        private readonly CursoInsertDto dto;
        public CusroInsertDtoValidatorTest()
        {
            dto = new CursoInsertDto();
            validations = new CursoInsertDtoValidator();
